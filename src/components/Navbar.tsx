      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center gap-4">
        ...
        <div className="hidden md:flex flex-1 max-w-md relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm bg-zinc-100 rounded-full border-0 outline-none focus:ring-2 focus:ring-red-200 placeholder:text-zinc-400 text-zinc-700"
          />
        </div>
