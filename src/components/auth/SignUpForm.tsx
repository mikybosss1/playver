  ...
  return (
    <div className="flex flex-col gap-5">
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <label className="flex items-start gap-2.5 cursor-pointer select-none">
          ...
          <span className="text-sm text-zinc-600 leading-snug">
            {t("termsPrefix")}{" "}
            <Link href="/legal/terms" className="text-[#e21d12] hover:underline font-medium">
              {t("termsLink")}
            </Link>{" "}
            {t("termsAnd")}{" "}
            <Link href="/legal/privacy" className="text-[#e21d12] hover:underline font-medium">
              {t("privacyLink")}
            </Link>
          </span>
        </label>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-3 text-sm font-semibold text-zinc-700 bg-white border border-zinc-200 rounded-lg hover:bg-zinc-50 hover:border-zinc-300 disabled:opacity-60 transition-colors shadow-sm"
      >
